            ...
            <table>
                <td valign="top">
                    <div class="content">
                        ...
                        <form:form modelAttribute="discountCode" class="pure-form" action="/HSDerby/mvc/discount_code/${action}">
                            <fieldset>
                                ...
                                <table class="pure-table pure-table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                <td><a href="/HSDerby/mvc/discount_code/get/${item.discountCode}"> 按我修改 </a></td>
                                                <td><a href="/HSDerby/mvc/discount_code/delete/${item.discountCode}"> 按我刪除 </a></td>
