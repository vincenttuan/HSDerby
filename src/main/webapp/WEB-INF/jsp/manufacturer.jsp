    ...
    <body>
        <div id="layout">
            ...
            <table>
                <td valign="top">
                    <div class="content">
                        <form:form modelAttribute="manufacturer" class="pure-form" action="/HSDerby/mvc/manufacturer/${action}">
                            <fieldset>
                                ...
                                <table class="pure-table pure-table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                <td><a href="/HSDerby/mvc/manufacturer/get/${item.manufacturerId}">按我修改</a></td>
                                                <td><a href="/HSDerby/mvc/manufacturer/delete/${item.manufacturerId}">按我刪除</a></td>
