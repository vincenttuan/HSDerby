    ...
    <body>
        <div id="layout">
            ...
            <table>
                <td valign="top">
                    <div class="content">
                        <form:form modelAttribute="customer" class="pure-form" action="/HSDerby/mvc/customer/${action}" method="post">
                            <fieldset>
                                <legend>
                                ...
                                <table class="pure-table pure-table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                <td><a href="/HSDerby/mvc/customer/get/${item.customerId}">修改</a></td>
                                                <td><a href="/HSDerby/mvc/customer/delete/${item.customerId}">刪除</a></td>
