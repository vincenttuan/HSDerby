            ...
            <table>
                <td valign="top">
                    <div class="content">
                        ...
                        <form:form modelAttribute="productCode" class="pure-form" action="/HSDerby/mvc/product_code/${action}">
                            <fieldset>
                                ...
                                <table class="pure-table pure-table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                <td><a href="/HSDerby/mvc/product_code/get/${item.prodCode}"> 按我修改 </a></td>
                                                <td><a href="/HSDerby/mvc/product_code/delete/${item.prodCode}"> 按我刪除 </a></td>
                                                <td>${item.prodCode}</td>
