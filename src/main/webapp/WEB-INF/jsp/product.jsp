            ...
            <table>
                <td valign="top">
                    <div class="content">
                        ...
                        <form:form modelAttribute="product" class="pure-form" action="/HSDerby/mvc/product/${action}">
                            <fieldset>
                                ...
                                <table class="pure-table pure-table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                <td><a href="/HSDerby/mvc/product/get/${item.productId}">修改</a></td>
                                                <td><a href="/HSDerby/mvc/product/delete/${item.productId}">刪除</a></td>
