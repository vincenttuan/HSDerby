            ...
            <table>
                <td valign="top">
                    <div class="content">
                        ...
                        <form:form modelAttribute="purchaseOrder" class="pure-form" action="/HSDerby/mvc/purchase_order/${action}">
                            <fieldset>
                                ...
                                <form:input path="salesDate" placeholder="Sales 日期" value="2020-01-09"/><p />
                                <form:input path="shippingDate" placeholder="Shipping 日期" value="2020-01-09"/><p />
                                ...
                                <table class="pure-table pure-table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                <td><a href="/HSDerby/mvc/purchase_order/get/${item.orderNum}">修改</a></td>
                                                <td><a href="/HSDerby/mvc/purchase_order/delete/${item.orderNum}">刪除</a></td>
                                                <td>${item.orderNum}</td>
